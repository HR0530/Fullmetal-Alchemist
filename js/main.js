...
letterBtn.addEventListener("click", () => {
  ...
  resultText.innerHTML = `
    ...
    できあがったのは、賢者の石でも、すごい力を持った何かでもなくて、
    今日のための小さな誕生日ケーキでした。

    24歳の誕生日おめでとう。

    こうして今年も、誕生日をお祝いできることが本当に嬉しいです。

    一緒にいる時間の中で、何気ない会話とか、笑っている顔とか、そういう一つひとつが、自分にとってすごく大切なものになっています。

    何か特別なことをしてあげられているかは分からないけど、
    これからも、嬉しいときは一緒に笑って、しんどいときは少しでも支えられる存在でいたいです。

    24歳の一年が、あなたにとって優しくて、楽しくて、たくさん笑える一年になりますように。
